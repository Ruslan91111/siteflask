import sqlite3
import os
from flask import Flask, render_template, request, g, flash, abort, make_response, url_for, redirect, session
...
DEBUG = True
SECRET_KEY = 'yuio30984ujkd39i83ie898ie94'
MAX_CONTENT_LENGTH = 1024 * 1024

app = Flask(__name__)
app.config.from_object(__name__)
app.config['SECRET_KEY'] = 'd28c29a46802a3be4f25f398eaa1c65660955a6a'
...
login_manager.login_message = "Авторизуйтесь для досутпа к закрытм страницам"
